...
public class AcTrajectorySlow extends Action
{
	...
	public AcTrajectorySlow(Check check, boolean shouldFinish, Trajectory trajectory, CtrlDrivetrain drivetrain, double leftMult, double rightMult, NumericSensor gyro, double gyroComp,
